...
//
// document.write('<ul>');
// for (let a = 0; a < listOfItems.length; a++){
//     document.write(`<li>${listOfItems[a]}</li>`);
// }
// document.write('<ul');
...
//         document.write(`<img src="${simpson.photo}" alt="simp">`);
//     }
// document.write('</div>');
...
//             document.write(`<img src="${product.image}" alt="pr" class="product-image">`);
//         document.write(`</div>`);
//     }
//
// document.write('</div>');
