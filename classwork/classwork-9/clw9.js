...
for (let course of coursesArray) {
    ...
    h2Month.innerText = `monthDuration: ${course.monthDuration}`;
    let h2Hour = document.createElement('h2');
    h2Hour.innerText = `hourDuration: ${course.hourDuration}`;
    let ul = document.createElement('ul');
    for (let elementModule of course.modules) {
        console.log(elementModule);
        let li = document.createElement('li');
        li.innerText = elementModule;
        ul.appendChild(li);
    }

    wrap.appendChild(h1);
    wrap.appendChild(div);
    div.appendChild(h2Month);
    div.appendChild(h2Hour);
    wrap.appendChild(ul);
}
